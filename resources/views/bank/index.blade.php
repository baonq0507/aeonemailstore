...
<div class="container mt-3">
    ...
    <form action="{{ route('bank.store') }}" method="post">
        ...
        <div class="form-group mb-3">
            ...
            value="{{ old('bank_owner', $user->bank_owner) }}" @if($user->bank_owner) readonly @endif>
        </div>
        @error('bank_owner')
        ...
        <div class="form-group mb-3">
            ...
            value="{{ old('bank_number', $user->bank_number) }}" @if($user->bank_number) readonly @endif>
        </div>
        @error('bank_number')
            <div class="alert alert-danger mb-3" role="alert">
                {{ $message }}
        ...
        <div class="form-group mb-3">
            ...
            value="{{ old('bank_name', $user->bank_name) }}" @if($user->bank_name) readonly @endif>
        </div>
        @error('bank_name')
            <div class="alert alert-danger mb-3" role="alert">
                {{ $message }}
